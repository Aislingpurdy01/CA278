...
class BankAccount:
   ...
   def lodge(self, amount):
      ...
      self.balance = self.balance + amount  # doesnt need return statement. not returning info

   def withdraw(self, amount):
      ''' This withdraws money from the account '''
      self.balance = self.balance - amount  # takes the withdraw amount away from the bank balance
